...
## Complete coordinate list is there as a reference to all original coordinates (nothing gets removed from it in the code)
...
def spaceMine(amaze,arr,d,coordinates):
    ...
    uList = []
    uCounter = 0 ## number of unopened
    mCounter = 0 #the number of mines
    neighbor = (neighbors(arr,d,coordinates)) ## surrounding neighbors for coordinate
