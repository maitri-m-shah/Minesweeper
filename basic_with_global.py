...
### This is the basic agent with the global information added
### The global information is added in the spaceMine method, the rest should be the same as the original file
import numpy as np
